...
namespace Fantasy
{
    public class AbstractMirrorMap : MonoBehaviour
    {
        ...
        public virtual GameObject mirrorCameraObj
        {
            get
            {
                return null;
    ...
    public class BaseMirrorMap : AbstractMirrorMap
    {
        ...
        public override GameObject mirrorCameraObj
        {
            get
            {
        ...
        protected virtual void Create()
        {
            ...
            else    //default: unity version 2019 
            {
                mRt = new RenderTexture(mImageSize, mImageSize, 0, RenderTextureFormat.ARGB32);
                mRt.antiAliasing = 8;
                mRt.autoGenerateMips = false;
        ...
        protected virtual void Initial()
        {
            ...
            if (mRt != null)
            {
                mTmpPic = new Texture2D(mRt.width, mRt.height, TextureFormat.ARGB32, false);
        ...
        protected virtual void Process()
        {
            ...
            if (mRt != null && mTmpPic != null)
            {
                ...
                */
                ...
                Graphics.CopyTexture(mRt, mTmpPic);
            }
        }
